<div id="rev_slider_1066_1" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.3.0.2">
    <ul>
        <li class="slider-li-one" data-index="rs-3004" data-transition="zoomout" data-slotamount="default"
            ...
            <!-- MAIN IMAGE -->
            <img src="{{ asset('images/slider/slider-1.jpg') }}" alt="" data-bgposition="center center"
                 data-bgfit="cover"
            ...
            <div class="tp-caption NotGeneric-Title tp-resizeme"
                 ...
                 style="font-family: 'Lora';z-index: 5; white-space: nowrap;text-transform:left;">{{ __('Find Your
                Perfect Wedding Vendor') }}
            </div>
            <!-- LAYER NR. 2 -->
            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme"
                 ...
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 6; white-space: nowrap;text-transform:left;">{{ __('Over 1200+
                Wedding Vendors For You Special Date &amp; Find The Perfect Venuw &amp; Save You Date') }}
            </div>
        </li>

        <!-- SLIDE 2 -->
        <li data-index="rs-3005" data-transition="fadetotopfadefrombottom" data-slotamount="default"
            ...
            <!-- MAIN IMAGE -->
            <img src="images/slider/slider-3.jpg" alt="" data-bgposition="center center" data-bgfit="cover"
                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            ...
            <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-3"
                 ...
                 data-paddingbottom="[10,10,10,10]"
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 10; white-space: nowrap;text-transform:left;">{{ __('Start
                Finding Your Wedding Vendor') }}
            </div>
            <!-- LAYER NR. 4 -->
            <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-2" id="slide-3005-layer-4"
                 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                 data-y="['middle','middle','middle','middle']" data-voffset="['52','52','52','51']" data-width="none"
                 data-height="none" data-whitespace="nowrap" data-type="text" data-responsive_offset="on"
                 data-frames='[{"from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","speed":2000,"to":"o:1;","delay":1500,"ease":"Power4.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'
                 data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]"
                 data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 11; white-space: nowrap;text-transform:left;">
                {{ __('Over 1200+ Wedding Vendors For You Special Date &amp; Find The Perfect Venuw &amp; Save You Date') }}
            </div>
            <!-- LAYER NR. 5 -->
            <div class="tp-caption   tp-resizeme rs-parallaxlevel-8"
                ...
                <div class="rs-looped rs-pendulum" data-easing="linearEaseNone" data-startdeg="-20"
                     data-enddeg="360" data-speed="35" data-origin="50% 50%"><img
                            src="{{ asset('images/slider/blurflake4.png') }}" alt=""
            ...
            <div class="tp-caption tp-resizeme rs-parallaxlevel-7"
                ...
                <div class="rs-looped rs-wave" data-speed="20" data-angle="0" data-radius="50px"
                     data-origin="50% 50%">
                    <img src="images/slider/blurflake3.png" alt=""
                         data-ww="['170px','170px','170px','170px']"
                         data-hh="['170px','170px','170px','170px']" width="170"
                         height="170" data-no-retina>
                </div>
            </div>
            <!-- LAYER NR. 7 -->
            <div class="tp-caption tp-resizeme rs-parallaxlevel-4"
                ...
                <div class="rs-looped rs-rotate" data-easing="Power2.easeInOut" data-startdeg="-20"
                     data-enddeg="360" data-speed="20" data-origin="50% 50%"><img
                            src="{{ asset('images/slider/blurflake2.png') }}" alt=""
                            data-ww="['50px','50px','50px','50px']" data-hh="['51px','51px','51px','51px']"
                            width="50" height="51" data-no-retina>
                </div>
            </div>
            <!-- LAYER NR. 8 -->
            <div class="tp-caption   tp-resizeme rs-parallaxlevel-6"
                ...
                <div class="rs-looped rs-wave" data-speed="4" data-angle="0" data-radius="10"
                     data-origin="50% 50%"><img src="{{ asset('images/slider/blurflake1.png') }}" alt=""
                                                data-ww="['120px','120px','120px','120px']"
                                                data-hh="['120px','120px','120px','120px']" width="120"
                                                height="120" data-no-retina>
                </div>
            </div>
        </li>

        <!-- SLIDE 3 -->
        <li data-index="rs-3006" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
            data-hideslideonmobile="off" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
            data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Enjoy Nature"
            data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
            data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
            <!-- MAIN IMAGE -->
            <img src="images/slider/slider-4.jpg" alt="" data-bgposition="center center" data-kenburns="on"
            ...
            <div class="tp-caption NotGeneric-Title   tp-resizeme"
                 ...
                 data-paddingbottom="[10,10,10,10]"
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 19; white-space: nowrap;text-transform:left;">{{ __('Weddlist
                have 2000+ wedding vendor in directory') }}
            </div>
            <!-- LAYER NR. 10 -->
            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme"
                 ...
                 data-paddingbottom="[0,0,0,0]"
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 20; white-space: nowrap;text-transform:left;">{{ __('Over
                1200+ Wedding Vendors For You Special Date &amp; Find The Perfect Venuw &amp; Save You Date') }}
            </div>
        </li>

        <!-- SLIDE 4 -->
        <li data-index="rs-3008" data-transition="zoomin" data-slotamount="7" data-hideafterloop="0"
            data-hideslideonmobile="off" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut"
            data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Hiking"
            data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
            data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
            <!-- MAIN IMAGE -->
            <img src="{{ asset('images/slider/slider-2.jpg') }}" alt="" data-bgposition="center center"
                 data-bgfit="cover"
                 data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
            <div class="overlay-bg clr-blk"></div>
            <!-- LAYERS -->
            ...
            <div class="tp-caption NotGeneric-Title   tp-resizeme"
                 ...
                 data-paddingbottom="[10,10,10,10]"
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 30; white-space: nowrap;text-transform:left;">{{ __('Find Your Perfect Wedding Vendor') }}
            </div>
            <!-- LAYER NR. 12 -->
            <div class="tp-caption NotGeneric-SubTitle   tp-resizeme"
                 ...
                 data-paddingbottom="[0,0,0,0]"
                 data-paddingleft="[0,0,0,0]"
                 style="font-family: 'Lora';z-index: 31; white-space: nowrap;text-transform:left;">{{ __('Over
                1200+ Wedding Vendors For You Special Date &amp; Find The Perfect Venuw &amp; Save You Date') }}
            </div>
            <a class="tp-caption NotGeneric-Button rev-btn "
               ...
               target="_blank" id="slide-3008-layer-10"
               data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
               ...
               style="font-family: 'Lora';z-index: 34; white-space: nowrap;text-transform:left;outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer;">{{ __('Find
                Vendor') }}</a>
        </li>
    </ul>
</div>
