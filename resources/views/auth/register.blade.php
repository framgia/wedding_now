                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <label for="gender">
                                    <input id="gender" type="radio" class="{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" value="male">
                                    Male
                                </label>
                                <label for="gender">
                                    <input id="gender" type="radio" class="{{ $errors->has('gender') ? ' is-invalid' : '' }}" name="gender" value="female">
                                    Female
                                </label>
