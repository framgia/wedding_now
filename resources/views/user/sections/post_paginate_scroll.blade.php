    ...
    <div class="pure-u-1-2 col-lg-6 pr-pl-0">
        <div class="articles-listing-box">
            <figure class="articles-listing-box-frame">
                <a href="{{ route('client.post.detail', ['topic' => str_slug($post->topic->name, '-'), 'id' => $post->id, 'slug' => str_slug($post->slug, '-')]) }}"><img class="articles-listing-box-image" src="{{ config('define.post.path') . $post->image }}"></a>
            </figure>
