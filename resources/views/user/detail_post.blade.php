...
<section class="breadcrumb-news">
    <div class="breadcrumb-wrap">
        ...
        <div class="search-wrap">
            <form action="detail_post_submit" method="get" accept-charset="utf-8">
                ...
                <div class="articles-post-heading">
                    ...
                    <div class="articles-post-heading-box">
                        <div class="box-user w-5">
                            <img class="articles-post-heading-box-avatar" src="{{ asset(config('asset.users.avatar') . $post->avatar_user) }}">
