@if (isset($page))
    <div class="_2fV_WHHHafq510ZMzFrSbO page page-main" data-id="">
                ...
                <div class="_3a984HDytkQ1wpz-WNzd7A">
                    <div class="_2lC2QtQshUItjm2q48r14s _2lC2QtQshUItjm2q48r14s-style card-wedding">
                        <div class="background">
                            <img class="img-fluid" data-base-asset="{{ asset(config('asset.card.vertical.template')) }}" src="{{ asset(config('asset.card.vertical.template'). $page->background) }}" alt="">
                        </div>
                        <div class="contain-box">
                            @foreach ($page->cardMetas as $box)
                                <div class="element drag" style="{{ $box->div_style }}" data-id="{{ $box->id }}">
        ...
        <div class="V6XejnQ8rEFlQzimE1p_D uHudNMvClWL2eGrKYVA2z">
            <div class="I_bUVGZm853-lyKpiaDqF _3xVoQD9L7ZqRisB_kXc31b re0cKcGxZsBmUDfVR7kCl">
                ...
                <div class="_3a984HDytkQ1wpz-WNzd7A">
                    <div class="_2lC2QtQshUItjm2q48r14s _2lC2QtQshUItjm2q48r14s-style card-wedding">
                        <div class="background">
                            <img alt="" class="img-fluid" data-base-asset="{{ asset(config('asset.card_template.template')) }}" src="">
                        </div>
                        <div class="contain-box">
                        </div>
                    </div>
