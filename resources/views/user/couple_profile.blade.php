...
@section('main-content')
    <section id="couple-profile" class="couple-profile-main-page">
        <div class="container">
            ...
            <div class="row">
                {{ Form::open(['id' => 'update_profile', 'class' => 'm-form m-form--fit m-form--label-align-right', 'route' => 'client.user.update', 'files' => true]) }}
                @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-2 col-sm-4">
                                    <div class="upload-img">
                                        @if(isset($user->media) && file_exists(config('asset.user.avatar'). $user->media->name))
                                            <img src="{{ asset(config('asset.user.avatar') . $user->media->name) }}"
                                                 alt="upload img" class="img-responsive" id="img-avatar">
                                        @else
                                            <img src="{{ asset(config('define.avatar_default')) }}" alt=""
                                                 id="img-avatar" class="img-responsive">
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-8">
                                        <label class="m-radio m-radio--state-success">
                                            {{ Form::radio('gender', __('page.profile.male'), ($user->gender == 'male' ? true : false),
                                             ['class' => 'gender-radio', 'id' => 'male-gender']) }}
                                        ...
                                        <label class="m-radio m-radio--state-brand">
                                            {{ Form::radio('gender', __('page.profile.female'), ($user->gender == 'female' ? true : false),
                                             ['class' => 'gender-radio', 'id' => 'female-gender']) }}
