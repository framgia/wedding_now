                            ...
                            <div id="show-list-category">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-10">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control category-filter">
                                                <option data-status="null" data-name="{{ __('base.all') }}"
                                                        data-type="status">
                                                    {{ __('base.all') }}
                                                </option>
                                                <option data-status="{{ config('define.done') }}"
                                                        data-name="{{ __('base.done') }}" data-type="status">
                                                    {{ __('base.done') }}
                                                </option>
                                                <option data-status="{{ config('define.to_do') }}"
                                                        data-name="{{ __('base.to_do') }}" data-type="status">
                                                    {{ __('base.to_do') }}
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-12 pd-0">
                                        ...
                                        <div class="col-md-7">
                                            <label for="radio_all">
                                                <input type="checkbox" checked id="radio_all" name="check_category"
                                                       class="category-filter" data-name="{{ __('page.filter.all') }}"
                                                       data-type="category"/>
                                                <span class="label-text">&emsp;{{ __('base.uncheck') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row col-md-12 padding-bottom-15">
                                            ...
                                            <div class="col-md-6 select-3">
                                                <select name="priority" class="form-control" id="task-priority">
                                                    <option value=""
                                                            hidden>{{ __('page.placeholder.priority') }}</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-6 col-sm-offset-3 select-3">
                                                <div class="show-list-group-item">
                                                    <div class="text-left">
                                                        <button type="button" class="btn btn-info btn-show-product"
                                                                data-toggle="modal"
                                                                data-target="#product-modal">{{ __('page.todo_list.show_item') }}</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@section('script')
    <script type="text/javascript" defer>
        jQuery(document).ready(function ($) {
            ...
            let statusDone = $('#status_done').val();

            let statusToDo = $('#status_to_do').val();
            ...
            function loadCategoryFilter() {
                ...
                $('.category-filter').click(function (event) {
                    ...
                    if ($(this).is('#radio_all')) {

                        $('.category-filter:not(#radio_all)').prop('checked', false);
                    ...
                    let conditionStatus = (status && status != undefined && status !== '');

                    let conditionCategory = (arrCategory && arrCategory != undefined && arrCategory !== '');
