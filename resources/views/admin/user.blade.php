        ...
        <div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
            <div class="row align-items-center">
                ...
                <div class="col-xl-4 order-1 order-xl-2 m--align-right">
                    <a href="#" data-toggle="modal" data-target="#m_modal_4" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
                        <span>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {!! Form::open(['method' => 'POST', 'route' => 'user.update', 'class' => 'm-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed']) !!}
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                {!! Form::label('name', __('admin.name')) !!}
                                {!! Form::text('name', '', ['required', 'class' => 'form-control m-input m-input--solid', 'placeholder' => __('admin.enter.name')]) !!}
                            </div>
                            <div class="col-lg-4">
                                {!! Form::label('email', __('admin.name')) !!}
                                {!! Form::email('email', '', ['required', 'class' => 'form-control m-input m-input--solid', 'placeholder' => __('admin.enter.name')]) !!}
                            </div>
                            <div class="col-lg-4">
                                {!! Form::label('phone', __('admin.phone')) !!}
                                {!! Form::number('phone', '', ['required', 'class' => 'form-control m-input m-input--solid', 'placeholder' => __('admin.enter.phone')]) !!}
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <div class="col-lg-6">
                        ...
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                ...
                                <div class="m-input-icon m-input-icon--right">
                                    <input type="text" class="form-control m-input m-input--solid" placeholder="{{ __('please.select.city') }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                {!! Form::label('district', __('admin.district')) !!}
                                <div class="m-input-icon m-input-icon--right">
                                    <input type="text" class="form-control m-input m-input--solid" placeholder="{{ __('please.select.district') }}">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                {!! Form::label('address', __('admin.address')) !!}
                                <div class="m-input-icon m-input-icon--right">
                                    <input type="text" class="form-control m-input m-input--solid" placeholder="{{ __('please.enter.address') }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <div class="col-lg-4">
                                {!! Form::label('username', __('admin.user_name')) !!}
                                {!! Form::text('username', '', ['class' => 'form-control m-input m-input--solid', 'required', 'placeholder' => __('admin.enter.username')]) !!}
                            </div>
                            <div class="col-lg-4">
                                <label>{{ __('admin.password') }}:</label>
                                <input type="text" class="form-control m-input m-input--solid" required placeholder="{{ __('please.enter.password') }}">
                            </div>
                            <div class="col-lg-4">
                                {!! Form::label('password_confirmation', __('admin.password_confirmation')) !!}
                                {!! Form::password('password_confirmation', ['required', 'class' => 'form-control m-input m-input--solid', 'placeholder' => __('admin.enter.password_confirmation')]) !!}
                            </div>
                        </div>
                    </div>
                {!! Form::close() !!}
                ...
                },
                {
                    field:'Actions', title:'Actions', sortable:!1, overflow:'visible', template:function(e, a, i) {
                        return `
                            ...
                            <a href="#" data-toggle="modal" data-target="#m_modal_4" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="View ">
