...
@section('content')
    <div class="m-portlet m-portlet--mobile">
        ...
        {{ Form::hidden('id', $post->id, ['id' => 'id-post']) }}
        <div class="m-portlet__body">
            <div class="form-group m-form__group row">
                {{ Form::label('title', __('base.title'), ['class' => 'col-form-label col-lg-1 col-sm-12']) }}
                <div class="col-lg-11 col-md-11 col-sm-12">
                    {{ Form::text('title', $post->title, ['class' => 'form-control m-input text-capitalize', 'placeholder' => __('base.title'), 'autocomplete' => 'off', 'id' => 'title-post']) }}
                </div>
            </div>
            <div class="form-group m-form__group row">
                {{ Form::label('topic', __('base.topic'), ['class' => 'col-form-label col-lg-1 col-sm-12']) }}
                <div class="col-lg-11 col-md-11 col-sm-12">
                    {{ Form::select('topic', $topics, $post->topic_id, ['class' => 'form-control m-input', 'id' => 'topic-select', 'placeholder'=> __('base.select')  . ' ' . __('base.topic')]) }}
                </div>
            </div>
            <div class="form-group m-form__group row">
                {{ Form::label('tag', __('base.tag'), ['class' => 'col-form-label col-lg-1 col-sm-12']) }}
                <div class="col-lg-11 col-md-11 col-sm-12 parent-tags">
                    {{ Form::select('tags[]', $tags, $post->tags, ['class' => 'form-control m-input', 'id' => 'tag', 'multiple' => 'multiple']) }}
                </div>
            </div>
            <div class="form-group m-form__group row">
                ...
                <div class="col-lg-11 col-md-11 col-sm-12 parent-content">
                    {{ Form::textarea('contents', $post->content, ['id' => 'contents']) }}
                </div>
            </div>
        </div>
            ...
            <div class="m-form__actions m-form__actions">
                <div class="row">
                    <div class="col-lg-3 ml-lg-auto">
                        {{ Form::submit(__('base.update'), ['class' => 'btn btn-outline-success', 'id' => 'submit-edit-post']) }}
