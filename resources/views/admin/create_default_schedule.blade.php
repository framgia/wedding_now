            ...
            <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                    <div class="m-form__section m-form__section--first">
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group m-form__group row">
                                    {!! Form::label('title-schedule', __('base.title'), ['class' => 'col-lg-3 col-form-label']) !!}
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group m-form__group row">
                                    {!! Form::label('budget-schedule', __('base.budget'), ['class' => 'col-lg-3 col-form-label']) !!}
                                    <div class="col-lg-9">
                            ...
                            <div class="col-6">
                                <div class="form-group m-form__group row">
                                    <label class="col-lg-3 col-form-label">{{ __('base.note') }}</label>
                                    <div class="col-lg-9">
                        ...
                        <div id="m_repeater">
                            <div class="form-group  m-form__group row">
                                {!! Form::label('', __('admin.task.task'), ['class' => 'col-lg-2 col-form-label']) !!}
