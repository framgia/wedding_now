...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset(config('asset.admin_base') . 'css/app.css') }}">
        @yield('css')
    </head>
    ...
    <div class="m-grid m-grid--hor m-grid--root m-page">
        ...
        <div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
            ...
            @include('layouts.admin.aside_menu')
    ...
    <script src="{{ asset('asset/ckeditor/ckeditor.js') }}" type="text/javascript"></script>
    <script src="{{ asset('asset/ckeditor/adapters/jquery.js') }}" type="text/javascript"></script>
    <script src="{{ asset(config('asset.admin_base') . 'js/app.js') }}" type="text/javascript"></script>
    @yield('js')
    </body>
</html>
